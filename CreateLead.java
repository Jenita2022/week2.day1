...
public class CreateLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Prajit Company");
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Pratyush");
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Jitesh");
